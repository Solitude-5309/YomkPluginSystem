...
#define YOMKPLUGIN_MANAGER_LIST()                                             \
  YOMK_REQUEST("/YomkPluginManager/list", nullptr)
#define YOMKPLUGIN_MANAGER_LIST_LIB(libId)                                    \
...
#define YOMKPLUGIN_MANAGER_INFO_PLUGIN(libId)                                 \
  YOMK_REQUEST("/YomkPluginManager/plugin", YomkMkPtr(String, libId))
#define YOMKPLUGIN_MANAGER_INFO_ALL()                                         \
